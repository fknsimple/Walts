...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIWindow *)view animated:(BOOL)animated {
	MBProgressHUD *hud = [[self alloc] initWithWindow:view];
...
+ (BOOL)hideHUDForView:(UIWindow *)view animated:(BOOL)animated {
...
+ (NSUInteger)hideAllHUDsForView:(UIWindow *)view animated:(BOOL)animated {
...
+ (MB_INSTANCETYPE)HUDForView:(UIWindow *)view {
...
+ (NSArray *)allHUDsForView:(UIWindow *)view {
